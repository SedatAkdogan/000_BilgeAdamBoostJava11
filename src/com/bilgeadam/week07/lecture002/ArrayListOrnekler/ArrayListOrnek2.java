...
//		}
		System.out.println("Tek sayilar : " + tekSayilar); // arraylist oldugu icin arraylist sınıfının icinde tostring methodu var yanyana yazdırır.

//		for (Integer ciftSayi : ciftSayilar) {
//			System.out.println(ciftSayi);
//		}

		System.out.println("Cift sayilar : " + ciftSayilar); // dizi seklinde gozukmesi için bu sekil yazdırdım.
		
	}
	public static int randomSayi() {
		Random random = new Random();
		return random.nextInt(500); // aralıklı olsun dedim kafama göre
	}
}

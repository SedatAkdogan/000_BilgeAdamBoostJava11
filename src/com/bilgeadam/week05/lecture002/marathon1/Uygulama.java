...
public class Uygulama {
	...
	public void uygulama() {
		...
		do {
			...
			case 2:
				hobileriGir();
//				for (int i = 0; i < hobiListesi.length; i++) { burayı hobileri dönüyor mu diye kontrol için yazdım
...
//				}
	...
	private void ogrenciTanımla() {
		System.out.print("Kac ogrenci tanımlayacaksınız : ");
